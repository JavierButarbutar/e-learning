...
class PresensiAktifModel {
  ...
  factory PresensiAktifModel.fromJson(Map<String, dynamic> json) =>
      PresensiAktifModel(
        idPresensi: (json['id_presensi'] as num?)?.toInt() ?? 0,
        ...
        batasTerlambat: json['batas_terlambat'] as String? ?? '-',

        faseWaktu: json['fase_waktu'] as String? ?? 'normal',

        sisaWaktuMenit: (json['sisa_waktu_menit'] as num?)?.toInt() ?? 0,

        sudahAbsen: json['sudah_absen'] as bool? ?? false,
