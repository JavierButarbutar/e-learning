...
class NotifikasiItem extends StatelessWidget {
  ...
  _IconConfig get _iconConfig {
    switch (notif.tipe) {
      case 'tugas_baru':
        return _IconConfig(Icons.assignment_outlined,
            const Color(0xFFFFF3E0), const Color(0xFFF5A623));
      case 'presensi_dibuka':
        return _IconConfig(Icons.qr_code_scanner_rounded,
            const Color(0xFFE8F5E9), const Color(0xFF2E7D32));
      case 'materi_baru':
        return _IconConfig(Icons.menu_book_outlined,
            const Color(0xFFE8F5E9), const Color(0xFF2E7D32));
      case 'kuis_baru':
        return _IconConfig(Icons.quiz_outlined,
            const Color(0xFFE3F2FD), const Color(0xFF1E88E5));
      default:
        return _IconConfig(Icons.notifications_outlined,
      ...
      child: Container(
        ...
        child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Container(
            ...
            height: 38,
            decoration: BoxDecoration(
                color: cfg.bg, borderRadius: BorderRadius.circular(10)),
