class ApiEndpoint {
  ...
  static String detailMapel(dynamic id) => "$baseUrl/mapel/$id";

  static String materiByMapel(dynamic id) => "$baseUrl/mapel/$id/materi";

  static String detailMateri(dynamic id) => "$baseUrl/materi/$id";
  ...
  static const String unreadNotifikasi = "$baseUrl/notifikasi/unread-count";

  static const String bacaSemuaNotifikasi = "$baseUrl/notifikasi/baca-semua";

  static const String updateFcmToken = "$baseUrl/notifikasi/update-token";

  static String bacaNotifikasi(dynamic id) => "$baseUrl/notifikasi/$id/baca";
}
